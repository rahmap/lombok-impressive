											...
											<div class="col-12">
													<div class="card">
															<div class="card-body">
																	...
																	<form action="<?= base_url('dashboard/add_photos_dest/'.$this->uri->segment('3')) ?>" method="POST" enctype="multipart/form-data">	
																	<div class="form-group row">
                                                                        <label for="example-text-input" class="col-md-2 col-form-label">Photo (Max 7 MB)</label>
                                                                        <div class="col-md-10">
                                                                            <input type="file" name="photo" <?= set_value('photo') ?> class="form-control" required>
